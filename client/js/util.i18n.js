...
const LANGUAGES = {
	...
	zh: {
		...
		translations: {
			...
			'help.what_is_nodecrypt': '🔐 什么是无痕之语？',			'help.what_is_nodecrypt_desc': '无痕之语是一个真正的端到端加密聊天系统。采用无数据库架构，所有消息在您的设备上本地加密，服务器仅作为加密数据的中转站，无法获取您的任何明文内容。',
